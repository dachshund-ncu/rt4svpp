...
void Rms_sec_widget::customizeApperance()
{
     ...
     */
    this->setDarkModeW();
    popupWindow->setDarkModeW();
    spectrumOnPopupWindow_w->setDarkModeW();
...
void Rms_sec_widget::customizeApperanceLight(){
     ...
     */
    this->setLightModeW();
    popupWindow->setLightModeW();
    spectrumOnPopupWindow_w->setLightModeW();
    RmsVsTime->legend->setBrush(QColor(0, 0, 0, 50));
    intVsTime->legend->setBrush(QColor(0, 0, 0, 50));
}
